...
export default function HomeBanner() {
  return (
    <div className='pt-5 w-full relative bg-gray-50'>
      <div
      ...
      <div className='mx-auto max-w-7xl bg-indigo-600 lg:bg-transparent lg:px-8'>
        <div className='lg:grid lg:grid-cols-12'>
          ...
          <div className='min-h-screen lg:min-h-0 relative bg-indigo-600 lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl'>
            <div
